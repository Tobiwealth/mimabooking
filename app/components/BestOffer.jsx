...
const BestOffer = () => {
	return (
		<section className=" p-8 pl-12 pr-20">
			...
			<div className="flex flex-col gap-6 lg:gap-0 md:grid md:grid-cols-3 lg:flex lg:flex-row justify-between items-center">
				<div className="w-[190px] flex flex-col justify-center items-center rounded-[20px] bg-white p-3 pb-5 gap-3 shadow-sm">
				    ...
				    <div className="text-sm font-medium text-[#0C0B4866] flex flex-col justify-center gap-2 w-full">
				    	<h3 className="text-sm font-bold text-[#152238]">7seasons Apartments</h3>
				...
				<div className="w-[190px] flex flex-col justify-center items-center rounded-[20px] bg-white p-3 pb-5 gap-3 shadow-sm">
				    ...
				    <div className="text-sm font-medium text-[#0C0B4866] flex flex-col justify-center gap-2 w-full">
				    	<h3 className="text-sm font-bold text-[#152238]">Along With The Villa</h3>
				...
				<div className="w-[190px] flex flex-col justify-center items-center rounded-[20px] bg-white p-3 pb-5 gap-3 shadow-sm">
				    ...
				    <div className="text-sm font-medium text-[#0C0B4866] flex flex-col justify-center gap-2 w-full">
				    	<h3 className="text-sm font-bold text-[#152238]">Resort and Recreation</h3>
				...
				<div className="w-[190px] flex flex-col justify-center items-center rounded-[20px] bg-white p-3 pb-5 gap-3 shadow-sm">
				    ...
				    <div className="text-sm font-medium text-[#0C0B4866] flex flex-col justify-center gap-2 w-full">
				    	<h3 className="text-sm font-bold text-[#152238]">Beautiful and Classy</h3>
				...
				<div className="w-[190px] flex flex-col justify-center items-center rounded-[20px] bg-white p-3 pb-5 gap-3 shadow-sm">
				    ...
				    <div className="text-sm font-medium text-[#0C0B4866] flex flex-col justify-center gap-2 w-full">
				    	<h3 className="text-sm font-bold text-[#152238]">Permanent Peace</h3>
