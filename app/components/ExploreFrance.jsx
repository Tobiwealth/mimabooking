...
const ExploreFrance = () => {
	return (
		<section className="mt-6 p-6 pl-12 pr-12">
			...
			<div className="flex flex-col gap-8 lg:gap-0 lg:flex-row justify-between items-center pr-8">
				<div className="flex justify-between items-center w-[20rem] gap-4 p-4 rounded-[20px] bg-white shadow-sm">
